...
vi.mock(
  "../components/charts/MarketPriceChart",
  () => ({
    MarketPriceChart: () => (
...
vi.mock(
  "../components/charts/MarketCandlestickChart",
  () => ({
...
describe(
  ...
  () => {
    ...
    it("preserves partial success, warnings, provenance, and successful charts", async () => {
      ...
      expect(
        screen.getByText(
          "2026-09-01 to 2026-09-17 (end exclusive)",
        ),
      ).toBeInTheDocument();
    ...
    it("switches candlestick detail locally without making another market-data request", async () => {
