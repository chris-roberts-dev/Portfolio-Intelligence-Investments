...
MAX_STALE_PRICE_TRADING_SESSIONS = 3
...
OPTIMIZATION_SOLVER_TOLERANCE = 1e-10
OPTIMIZATION_POST_VALIDATION_TOLERANCE = 1e-8
OPTIMIZATION_TARGET_RETURN_TOLERANCE = 1e-7
OPTIMIZATION_MAX_SOLVER_ITERATIONS = 1_000
OPTIMIZATION_DEFAULT_FRONTIER_POINTS = 25
OPTIMIZATION_MAX_FRONTIER_POINTS = 100
