"""Architecture tests for the Django domain-app scaffold."""
...
EXPECTED_APP_CONFIGS = (
    ...
    (
        "apps.market_data.apps",
        "MarketDataConfig",
        "apps.market_data",
        "market_data",
    ),
    (
        "apps.portfolios.apps",
        "PortfoliosConfig",
        "apps.portfolios",
        "portfolios",
    ),
    ...
    (
        "apps.rebalancing.apps",
        "RebalancingConfig",
        "apps.rebalancing",
        "rebalancing",
    ),
    (
        "apps.backtesting.apps",
        "BacktestingConfig",
        "apps.backtesting",
        "backtesting",
    ),
...
def test_domain_app_scaffolds_define_explicit_app_configs() -> None:
    """Every implemented project app should expose an explicit AppConfig."""
    for (
        module_name,
        class_name,
        expected_name,
        _label,
    ) in EXPECTED_APP_CONFIGS:
